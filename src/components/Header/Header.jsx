                ...
                <div className="header-content">
                    <div className="header-left">
                        <div className="logo-part pe-4">
                            <Link to="/" className="logo-link">
                                <span className="logo-gold">GOLD777</span>
                                <span className="logo-by">BY</span>
                                <span className="logo-mebel">MEBEL</span>
                            </Link>
                        </div>
                    ...
                    <div className="header-right">
                        ...
                        <div className="hamburger-menu">
                            {hamburger ? (
                                <button onClick={() => { openHamburger() }}><GiHamburgerMenu /></button>
                            ) : (
                                <button onClick={() => { closeHamburger() }}><IoCloseSharp /></button>
                            )}
                        </div>
                    </div>
                </div>
